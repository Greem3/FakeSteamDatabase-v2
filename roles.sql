...
-- DENY SELECT ON TRANSACTIONS TO NOT_REGISTERED
-- DENY SELECT ON TRANS_GAMES TO NOT_REGISTERED
-- DENY SELECT ON WISHLISTS TO NOT_REGISTERED
-- DENY SELECT ON BOOKSTORES TO NOT_REGISTERED
...
EXEC SP_ADD_ROLE_MEMBER
     'ADMIN_OPTIONS',
     'datareader,datawriter,ddladmin,backupoperator,accessadmin'
